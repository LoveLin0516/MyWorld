...
//        Collections.addAll(new ArrayList<int[]>(), array);
        ...
        String result = com.example.myworld.cstructure.TestTraverseTreeCengCi.serialize(head);
        System.out.println("traverse---->" + result);

        String frontResult = com.example.myworld.cstructure.TestTraverseTreeFront.serialize(head);
        System.out.println("traverse--front-->" + frontResult);

        String midResult = com.example.myworld.cstructure.TestTraverseTreeMid.serialize(head);
