...
class Node4<T>(val value: T, val init: (String, T)->T){
...
fun main() {
    ...
    val thirdNode: Node4<String> = Node4("Name", {aa:String, bb:String ->
        "nihao"
    })

    val thridNode2= Node4("123", { s: String, s1: String ->
        ""
    })

    val fourthNode: Node4<String> = Node4("Name2", {aa:String, bb:String -> "111"})

    val fifth: Node<Int> = Node(123, {
        third
    })
    val six: Node<Int> = Node(123, {
        third
    })
