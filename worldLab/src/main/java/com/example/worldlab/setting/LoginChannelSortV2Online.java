...
//                return "{\"is_enable\":1,\"channel_list\":[\"gg\",\"fb\",\"ph\",\"onekey\",\"imo\",\"mail\",\"vk\"],\"second_channel\":[\"gg\",\"fb\"]}";
//            } else if ("RU".equalsIgnoreCase(country) || "BY".equalsIgnoreCase(country)) {
//                return "{\"is_enable\":1,\"channel_list\":[\"vk\",\"gg\",\"fb\",\"ph\",\"onekey\",\"imo\",\"mail\",\"ok\"],\"second_channel\":[\"gg\",\"fb\"]}";
//            } else if ("IN".equalsIgnoreCase(country)) {
//                return "{\"is_enable\":1,\"channel_list\":[\"ph\",\"mail\",\"tc\",\"fb\",\"onekey\",\"gg\",\"imo\"],\"second_channel\":[\"tc\",\"fb\"]}";
//            } else if ("CN".equalsIgnoreCase(country)) {
//                return "{\"is_enable\":1,\"channel_list\":[\"ph\",\"mail\",\"onekey\",\"we\",\"qq\",\"wb\",\"fb\",\"gg\",\"imo\"],\"second_channel\":[]}";
//            } else if("SA".equalsIgnoreCase(country)){
//                return "{\"is_enable\":1,\"channel_list\":[\"imo\",\"ph\",\"mail\",\"fb\",\"gg\",\"onekey\",\"vk\"],\"second_channel\":[\"fb\",\"gg\"]}";
//            } else if("BD".equalsIgnoreCase(country) || "AE".equalsIgnoreCase(country) || "BH".equalsIgnoreCase(country) || "KW".equalsIgnoreCase(country) || "OM".equalsIgnoreCase(country) || "QA".equalsIgnoreCase(country)){
//                return "{\"is_enable\":1,\"channel_list\":[\"ph\",\"imo\",\"mail\",\"fb\",\"gg\",\"onekey\",\"vk\"],\"second_channel\":[\"imo\",\"fb\",\"gg\"]}";
//            } else {
//                return "{\"is_enable\":1,\"channel_list\":[\"ph\",\"gg\",\"fb\",\"onekey\",\"imo\",\"mail\",\"vk\"],\"second_channel\":[\"gg\",\"fb\"]}";
//            }
